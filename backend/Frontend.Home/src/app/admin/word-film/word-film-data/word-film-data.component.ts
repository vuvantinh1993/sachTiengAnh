...
@Component({
  selector: 'app-word-film-data',
  templateUrl: './word-film-data.component.html',
  styleUrls: ['./word-film-data.component.scss']
})
export class WordFilmDataComponent extends BaseDataComponent implements OnInit {

  @Input() item: any;
  public openTab = 1;
  public name = 'Word-film';
