...
let applicationPaths: ApplicationPathsType = {
  ...
  UserInfoUrl: `${environment.identityServer}/connect/userinfo`,
  ApiAuthorizationClientConfigurationUrl: `${environment.identityServer}/_configuration/${ApplicationName}`,
