...
namespace CTIN.WebApi.Modules.General.Controllers
{
    ...
    public class ProjGeneralController : ApiController
    {
        private readonly IProjGeneralService _sv;
        public readonly ICurrentUserService _currentUserService;

        public ProjGeneralController(IProjGeneralService sv, ICurrentUserService currentUserService)
        {
            _sv = sv;
        ...
        /// </returns>
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] Search_ProjGeneralModel model)
        {
        ...
        /// </returns>
        [HttpPost]
        public async Task<object> Add([FromBody] Add_ProjGeneralModel model)
        {

            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Add_ProjGeneralServiceModel>();
        ...
        /// <summary>
        /// sửa dữ liệu Bảng ProjGeneral - Thông tin chung dự án
        /// </summary>
        ...
        /// </returns>
        [HttpPut("{id}")]
        public async Task<object> Edit(int id, [FromBody] Edit_ProjGeneralModel model)
        {
            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Edit_ProjGeneralServiceModel>();
                //set value default
                modelService.id = id;
                modelService.modifiedBy = _currentUserService.userId;
                modelService.modifiedDate = DateTime.Now;
        ...
        public async Task<object> Delete(int id)
        {
            if (ModelState.IsValid)
            {
                var modelService = new Delete_ProjGeneralServiceModel { id = id };
        ...
        /// </returns>
        [HttpGet("FindOne")]
        public async Task<object> FindOne([FromQuery] FindOne_ProjGeneralModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<object> FindOneById([FromRoute] int id)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = await _sv.FindOne(new FindOne_ProjGeneralServiceModel { where = where });
                return await BindData(result.data, result.errors);
            }
            return await BindData();
        }
        ...
        /// </returns>
        [HttpGet("Count")]
        public async Task<object> Count([FromQuery] Count_ProjGeneralModel model)
        {
            if (ModelState.IsValid)
            {
