...
namespace CTIN.WebApi.Modules.General.Controllers
{
    ...
    public class HandoverScheduleController : ApiController
    {
        private readonly IHandoverScheduleService _sv;
        public readonly ICurrentUserService _currentUserService;

        public HandoverScheduleController(IHandoverScheduleService sv, ICurrentUserService currentUserService)
        {
            _sv = sv;
        ...
        /// <summary>
        /// lấy dữ liệu Bảng HandoverSchedule - Tiến độ bàn giao
        /// </summary>
        /// <param name="model">
        ...
        /// </returns>
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] Search_HandoverScheduleModel model)
        {
        ...
        /// <summary>
        /// thêm dữ liệu Bảng HandoverSchedule - Tiến độ bàn giao
        /// </summary>
        /// <param name="model">
        ...
        /// </returns>
        [HttpPost]
        public async Task<object> Add([FromBody] Add_HandoverScheduleModel model)
        {

            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Add_HandoverScheduleServiceModel>();
        ...
        /// <summary>
        /// sửa dữ liệu Bảng HandoverSchedule - Tiến độ bàn giao
        /// </summary>
        ...
        /// </returns>
        [HttpPut("{id}")]
        public async Task<object> Edit(int id, [FromBody] Edit_HandoverScheduleModel model)
        {
            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Edit_HandoverScheduleServiceModel>();
                //set value default
                modelService.id = id;
                modelService.modifiedBy = _currentUserService.userId;
                modelService.modifiedDate = DateTime.Now;
        ...
        /// <summary>
        /// Chỉnh sửa một số dữ liệu Bảng HandoverSchedule - Tiến độ bàn giao
        /// </summary>
        /// <param name="id"> là id của đối tượng cần chỉnh sửa </param>
        ...
        /// <summary>
        /// Xóa dữ liệu Bảng HandoverSchedule theo id - Tiến độ bàn giao
        /// </summary>
        ...
        public async Task<object> Delete(int id)
        {
            if (ModelState.IsValid)
            {
                var modelService = new Delete_HandoverScheduleServiceModel { id = id };
        ...
        /// <summary>
        /// Tìm dữ liệu đầu tiên phù hợp model của Bảng HandoverSchedule - Tiến độ bàn giao
        /// </summary>
        ...
        /// </returns>
        [HttpGet("FindOne")]
        public async Task<object> FindOne([FromQuery] FindOne_HandoverScheduleModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<object> FindOneById([FromRoute] int id)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = await _sv.FindOne(new FindOne_HandoverScheduleServiceModel { where = where });
                return await BindData(result.data, result.errors);
            }
            return await BindData();
        }
        ...
        /// <summary>
        /// Đếm số row Bảng HandoverSchedule theo điều kiện model - Tiến độ bàn giao
        /// </summary>
        /// <param name="model"> là biểu thức điều kiện Where truyền lên</param>
        /// <param>
        ///     Kiểm tra ModelState xem có hợp lệ không
        ...
        /// </returns>
        [HttpGet("Count")]
        public async Task<object> Count([FromQuery] Count_HandoverScheduleModel model)
        {
            if (ModelState.IsValid)
            {
