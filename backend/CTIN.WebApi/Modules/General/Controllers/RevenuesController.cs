...
namespace CTIN.WebApi.Modules.General.Controllers
{
    ...
    {
        private readonly IRevenuesService _sv;
        public readonly ICurrentUserService _currentUserService;

        public RevenuesController(IRevenuesService sv, ICurrentUserService currentUserService)
        {
            _sv = sv;
        ...
        /// <summary>
        /// lấy dữ liệu Bảng Revenues - Doanh thu
        /// </summary>
        /// <param name="model">
        ...
        /// </returns>
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] Search_RevenuesModel model)
        {
        ...
        /// <summary>
        /// thêm dữ liệu Bảng Revenues - Doanh thu
        /// </summary>
        /// <param name="model">
        ...
        /// </returns>
        [HttpPost]
        public async Task<object> Add([FromBody] Add_RevenuesModel model)
        {
            var modelService = model.MapToObject<Add_RevenuesServiceModel>();
        ...
        /// <summary>
        /// sửa dữ liệu Bảng Revenues - Doanh thu
        /// </summary>
        ...
        /// </returns>
        [HttpPut("{id}")]
        public async Task<object> Edit(int id, [FromBody] Edit_RevenuesModel model)
        {

            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Edit_RevenuesServiceModel>();
                //set value default
                modelService.id = id;
        ...
        /// <summary>
        /// Chỉnh sửa một số dữ liệu Bảng Revenues - Doanh thu
        /// </summary>
        /// <param name="vouchersNumber"> là id của đối tượng cần chỉnh sửa </param>
        ...
        /// <summary>
        /// Xóa dữ liệu Bảng Revenues theo id - Chi phí kế hoạch
        /// </summary>
        ...
        public async Task<object> Delete(int id)
        {
            ...
            if (ModelState.IsValid)
            {
                var modelService = new Delete_RevenuesServiceModel { id = id };
                //set value default
        ...
        /// <summary>
        /// Tìm dữ liệu đầu tiên phù hợp model của Bảng Revenues - Doanh thu
        /// </summary>
        ...
        /// </returns>
        [HttpGet("FindOne")]
        public async Task<object> FindOne([FromQuery] FindOne_RevenuesModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        /// <summary>
        /// Tìm dữ liệu đầu tiên phù hợp id của Bảng Revenues - Doanh thu
        /// </summary>
        ...
        public async Task<object> FindOneById([FromRoute] int id)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = await _sv.FindOne(new FindOne_RevenuesServiceModel { where = where });
                return await BindData(result.data, result.errors);
            }
            return await BindData();
        }
        ...
        /// <summary>
        /// Đếm số row Bảng Revenues theo điều kiện model - Chi phí kế hoạch
        /// </summary>
        /// <param name="model"> là biểu thức điều kiện Where truyền lên</param>
        /// <param>
        ///     Kiểm tra ModelState xem có hợp lệ không
        ...
        /// </returns>
        [HttpGet("Count")]
        public async Task<object> Count([FromQuery] Count_RevenuesModel model)
        {
            if (ModelState.IsValid)
            {
