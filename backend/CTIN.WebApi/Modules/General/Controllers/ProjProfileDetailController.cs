...
{
    public class ProjProfileDetailController : ApiController
    {
        private readonly IProjProfileDetailService _sv;
        public readonly ICurrentUserService _currentUserService;

        public ProjProfileDetailController(IProjProfileDetailService sv, ICurrentUserService currentUserService)
        {
            _sv = sv;
        ...
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] Search_ProjProfileDetailModel model)
        {
        ...
        [HttpPost]
        public async Task<object> Add([FromBody] Add_ProjProfileDetailModel model)
        {
            var modelService = model.MapToObject<Add_ProjProfileDetailServiceModel>();
            //set value default
        ...
        [HttpPut("{id}")]
        public async Task<object> Edit(int id, [FromBody] Edit_ProjProfileDetailModel model)
        {

            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Edit_ProjProfileDetailServiceModel>();
                //set value default
                modelService.id = id;
        ...
        public async Task<object> Delete(int id)
        {
            ...
            if (ModelState.IsValid)
            {
                var modelService = new Delete_ProjProfileDetailServiceModel { id = id };
                //set value default
        ...
        [HttpGet("FindOne")]
        public async Task<object> FindOne([FromQuery] FindOne_ProjProfileDetailModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<object> FindOneById([FromRoute] int id)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = await _sv.FindOne(new FindOne_ProjProfileDetailServiceModel { where = where });
                return await BindData(result.data, result.errors);
            }
            return await BindData();
        }
        ...
        [HttpGet("Count")]
        public async Task<object> Count([FromQuery] Count_ProjProfileDetailModel model)
        {
            if (ModelState.IsValid)
            {
