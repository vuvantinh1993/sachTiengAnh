...
namespace CTIN.WebApi.Modules.General.Controllers
{
    ...
    public class ProjectResourcesController : ApiController
    {
        private readonly IProjectResourcesService _sv;
        public readonly ICurrentUserService _currentUserService;

        public ProjectResourcesController(IProjectResourcesService sv, ICurrentUserService currentUserService)
        {
            _sv = sv;
        ...
        /// <summary>
        /// lấy dữ liệu Bảng ProjectResources - Thông tin nguồn nhân lực
        /// </summary>
        /// <param name="model">
        ...
        /// </returns>
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] Search_ProjectResourcesModel model)
        {
        ...
        /// <summary>
        /// thêm dữ liệu Bảng ProjectResources - Thông tin nguồn nhân lực
        /// </summary>
        /// <param name="model">
        ...
        /// </returns>
        [HttpPost]
        public async Task<object> Add([FromBody] Add_ProjectResourcesModel model)
        {

            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Add_ProjectResourcesServiceModel>();
        ...
        /// <summary>
        /// sửa dữ liệu Bảng ProjectResources - Thông tin nguồn nhân lực
        /// </summary>
        ...
        /// </returns>
        [HttpPut("{id}")]
        public async Task<object> Edit(int id, [FromBody] Edit_ProjectResourcesModel model)
        {
            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Edit_ProjectResourcesServiceModel>();
                //set value default
                modelService.id = id;
                modelService.modifiedBy = _currentUserService.userId;
                modelService.modifiedDate = DateTime.Now;
        ...
        /// <summary>
        /// Chỉnh sửa một số dữ liệu Bảng ProjectResources - Thông tin nguồn nhân lực
        /// </summary>
        /// <param name="id"> là id của đối tượng cần chỉnh sửa </param>
        ...
        /// <summary>
        /// Xóa dữ liệu Bảng ProjectResources theo id - Thông tin nguồn nhân lực
        /// </summary>
        ...
        public async Task<object> Delete(int id)
        {
            if (ModelState.IsValid)
            {
                var modelService = new Delete_ProjectResourcesServiceModel { id = id };
        ...
        /// <summary>
        /// Tìm dữ liệu đầu tiên phù hợp model của Bảng ProjectResources - Thông tin nguồn nhân lực
        /// </summary>
        ...
        /// </returns>
        [HttpGet("FindOne")]
        public async Task<object> FindOne([FromQuery] FindOne_ProjectResourcesModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        /// <summary>
        /// Tìm dữ liệu đầu tiên phù hợp id của Bảng ProjectResources - Thông tin nguồn nhân lực
        /// </summary>
        ...
        public async Task<object> FindOneById([FromRoute] int id)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = await _sv.FindOne(new FindOne_ProjectResourcesServiceModel { where = where });
                return await BindData(result.data, result.errors);
            }
            return await BindData();
        }
        ...
        /// <summary>
        /// Đếm số row Bảng ProjectResources theo điều kiện model - Thông tin nguồn nhân lực
        /// </summary>
        /// <param name="model"> là biểu thức điều kiện Where truyền lên</param>
        /// <param>
        ///     Kiểm tra ModelState xem có hợp lệ không
        ...
        /// </returns>
        [HttpGet("Count")]
        public async Task<object> Count([FromQuery] Count_ProjectResourcesModel model)
        {
            if (ModelState.IsValid)
            {
