...
namespace CTIN.WebApi.Modules.General.Controllers
{
    ...
    {
        private readonly ICrService _sv;
        public readonly ICurrentUserService _currentUserService;

        public CrController(ICrService sv, ICurrentUserService currentUserService)
        {
            _sv = sv;
        ...
        /// <summary>
        /// lấy dữ liệu Bảng Cr - Thông tin thay đổi
        /// </summary>
        /// <param name="model">
        ...
        ///     Nếu Không hợp lệ gọi làm BindData truyền BadRequest ra
        /// </param>
        /// <returns>
        ///     Trả về data
        ...
        /// </returns>
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] Search_CrModel model)
        {
        ...
        /// <summary>
        /// thêm dữ liệu Bảng Cr - Thông tin thay đổi
        /// </summary>
        /// <param name="model">
        ...
        /// </returns>
        [HttpPost]
        public async Task<object> Add([FromBody] Add_CrModel model)
        {

            var modelService = model.MapToObject<Add_CrServiceModel>();

            //CheckErorrs(modelService);
            if (ModelState.IsValid)
            {
                //set value default
        ...
        /// <summary>
        /// sửa dữ liệu Bảng Cr - Thông tin thay đổi
        /// </summary>
        ...
        /// </returns>
        [HttpPut("{id}")]
        public async Task<object> Edit(int id, [FromBody] Edit_CrModel model)
        {
            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Edit_CrServiceModel>();
                //set value default
                modelService.id = id;
                modelService.modifiedBy = _currentUserService.userId;
                modelService.modifiedDate = DateTime.Now;
        ...
        /// <summary>
        /// Chỉnh sửa một số dữ liệu Bảng Cr - Thông tin thay đổi
        /// </summary>
        /// <param name="id"> là id của đối tượng cần chỉnh sửa </param>
        ...
        /// <summary>
        /// Xóa dữ liệu Bảng Cr theo id - Thông tin thay đổi
        /// </summary>
        ...
        public async Task<object> Delete(int id)
        {
            if (ModelState.IsValid)
            {
                var modelService = new Delete_CrServiceModel { id = id };
        ...
        /// <summary>
        /// Tìm dữ liệu đầu tiên phù hợp model của Bảng Cr - Thông tin thay đổi
        /// </summary>
        ...
        /// </returns>
        [HttpGet("FindOne")]
        public async Task<object> FindOne([FromQuery] FindOne_CrModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<object> FindOneById([FromRoute] int id)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = await _sv.FindOne(new FindOne_CrServiceModel { where = where });
                return await BindData(result.data, result.errors);
            }
            return await BindData();
        }
        ...
        /// <summary>
        /// Đếm số row Bảng Cr theo điều kiện model - Thông tin thay đổi
        /// </summary>
        /// <param name="model"> là biểu thức điều kiện Where truyền lên</param>
        /// <param>
        ///     Kiểm tra ModelState xem có hợp lệ không
        ...
        /// </returns>
        [HttpGet("Count")]
        public async Task<object> Count([FromQuery] Count_CrModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpGet("ListCrType")]
        public async Task<object> ListCrType()
        {
            var listData = Enum.GetValues(typeof(Common.Enums.CrType))
                               .Cast<Common.Enums.CrType>()
