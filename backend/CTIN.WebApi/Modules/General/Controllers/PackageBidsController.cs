...
{
    public class PackageBidsController : ApiController
    {
        private readonly IPackageBidsService _sv;
        public readonly ICurrentUserService _currentUserService;

        public PackageBidsController(IPackageBidsService sv, ICurrentUserService currentUserService)
        {
            _sv = sv;
        ...
        /// <summary>
        /// lấy dữ liệu Bảng PackageBids - Gói thầu
        /// </summary>
        /// <param name="model">
        ...
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] Search_PackageBidsModel model)
        {
        ...
        /// <summary>
        /// thêm dữ liệu Bảng PackageBids - Gói thầu
        /// </summary>
        /// <param name="model">
        ...
        /// </returns>
        [HttpPost]
        public async Task<object> Add([FromBody] Add_PackageBidsModel model)
        {

            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Add_PackageBidsServiceModel>();
                //set value default
        ...
        /// <summary>
        /// sửa dữ liệu Bảng PackageBids - Gói thầu
        /// </summary>
        ...
        /// </returns>
        [HttpPut("{id}")]
        public async Task<object> Edit(int id, [FromBody] Edit_PackageBidsModel model)
        {
            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Edit_PackageBidsServiceModel>();
                //set value default
                modelService.id = id;
                modelService.modifiedBy = _currentUserService.userId;
                modelService.modifiedDate = DateTime.Now;
        ...
        /// <summary>
        /// Chỉnh sửa một số dữ liệu Bảng PackageBids - Gói thầu
        /// </summary>
        /// <param name="id"> là id của đối tượng cần chỉnh sửa </param>
        ...
        /// <summary>
        /// Xóa dữ liệu Bảng PackageBids theo id - Gói thầu
        /// </summary>
        ...
        public async Task<object> Delete(int id)
        {
            if (ModelState.IsValid)
            {
                var modelService = new Delete_PackageBidsServiceModel { id = id };
        ...
        /// <summary>
        /// Tìm dữ liệu đầu tiên phù hợp model của Bảng PackageBids - Gói thầu
        /// </summary>
        ...
        /// </returns>
        [HttpGet("FindOne")]
        public async Task<object> FindOne([FromQuery] FindOne_PackageBidsModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<object> FindOneByID([FromRoute] long id)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = await _sv.FindOne(new FindOne_PackageBidsServiceModel { where = where });
                return await BindData(result.data, result.errors);
            }
            return await BindData();
        }
        ...
        /// <summary>
        /// Đếm số row Bảng PackageBids theo điều kiện model - Gói thầu
        /// </summary>
        /// <param name="model"> là biểu thức điều kiện Where truyền lên</param>
        /// <param>
        ///     Kiểm tra ModelState xem có hợp lệ không
        ...
        /// </returns>
        [HttpGet("Count")]
        public async Task<object> Count([FromQuery] Count_PackageBidsModel model)
        {
            if (ModelState.IsValid)
            {
