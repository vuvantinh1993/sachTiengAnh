...
namespace CTIN.WebApi.Modules.General.Controllers
{
    ...
    {
        private readonly ITimeSheetService _sv;

        public readonly ICurrentUserService _currentUserService;

        public TimeSheetController(ITimeSheetService sv, ICurrentUserService currentUserService)
        {
            _sv = sv;
        ...
        /// <summary>
        /// lấy dữ liệu Bảng TimeSheet - Thời gian biểu
        /// </summary>
        /// <param name="model">
        ...
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] Search_TimeSheetModel model)
        {
        ...
        /// <summary>
        /// thêm dữ liệu Bảng TimeSheet - Thời gian biểu
        /// </summary>
        /// <param name="model">
        ...
        /// </returns>
        [HttpPost]
        public async Task<object> Add([FromBody] Add_TimeSheetModel model)
        {

            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Add_TimeSheetServiceModel>();
        ...
        /// <summary>
        /// sửa dữ liệu Bảng TimeSheet - Thời gian biểu
        /// </summary>
        ...
        /// </returns>
        [HttpPut("{id}")]
        public async Task<object> Edit(int id, [FromBody] Edit_TimeSheetModel model)
        {
            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Edit_TimeSheetServiceModel>();
                //set value default
                modelService.id = id;
        ...
        /// <summary>
        /// Chỉnh sửa một số dữ liệu Bảng TimeSheet - Thời gian biểu
        /// </summary>
        /// <param name="id"> là id của đối tượng cần chỉnh sửa </param>
        ...
        /// <summary>
        /// Xóa dữ liệu Bảng TimeSheet theo id - Hồ sơ mời thầu
        /// </summary>
        ...
        public async Task<object> Delete(int id)
        {
            if (ModelState.IsValid)
            {
                var modelService = new Delete_TimeSheetServiceModel { id = id, userId = GetUserId() };
        ...
        /// <summary>
        /// Tìm dữ liệu đầu tiên phù hợp model của Bảng TimeSheet - Thời gian biểu
        /// </summary>
        ...
        /// </returns>
        [HttpGet("FindOne")]
        public async Task<object> FindOne([FromQuery] FindOne_TimeSheetModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<object> FindOneByID([FromRoute] long id)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var result = await _sv.FindOne(new FindOne_TimeSheetServiceModel { where = where });
        ...
        /// <summary>
        /// Đếm số row Bảng TimeSheet theo điều kiện model - Hồ sơ mời thầu
        /// </summary>
        /// <param name="model"> là biểu thức điều kiện Where truyền lên</param>
        /// <param>
        ///     Kiểm tra ModelState xem có hợp lệ không
        ...
        /// </returns>
        [HttpGet("Count")]
        public async Task<object> Count([FromQuery] Count_TimeSheetModel model)
        {
            if (ModelState.IsValid)
            {
