...
{
    public class ProjWorksController : ApiController
    {
        private readonly IProjWorksService _sv;
        public readonly ICurrentUserService _currentUserService;

        public ProjWorksController(IProjWorksService sv, ICurrentUserService currentUserService)
        {
            _sv = sv;
        ...
        /// <summary>
        /// lấy dữ liệu Bảng ProjWorks - Công việc dự án
        /// </summary>
        /// <param name="model">
        ...
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] Search_ProjWorksModel model)
        {
        ...
        /// <summary>
        /// thêm dữ liệu Bảng ProjWorks - Công việc dự án
        /// </summary>
        /// <param name="model">
        ...
        /// </returns>
        [HttpPost]
        public async Task<object> Add([FromBody] Add_ProjWorksModel model)
        {

            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Add_ProjWorksServiceModel>();
                checkErrors(modelService);
        ...
        private void checkErrors(Add_ProjWorksServiceModel modelService)
        {
        ...
        /// <summary>
        /// sửa dữ liệu Bảng ProjWorks - Công việc dự án
        /// </summary>
        ...
        /// </returns>
        [HttpPut("{id}")]
        public async Task<object> Edit(int id, [FromBody] Edit_ProjWorksModel model)
        {
            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Edit_ProjWorksServiceModel>();
                modelService.id = id;
                modelService.modifiedBy = _currentUserService.userId;
                modelService.modifiedDate = DateTime.Now;
        ...
        /// <summary>
        /// Chỉnh sửa một số dữ liệu Bảng ProjWorks - Công việc dự án
        /// </summary>
        /// <param name="id"> là id của đối tượng cần chỉnh sửa </param>
        ...
        /// <summary>
        /// Xóa dữ liệu Bảng ProjWorks theo id - Công việc dự án
        /// </summary>
        ...
        public async Task<object> Delete(int id)
        {
            if (ModelState.IsValid)
            {
                var modelService = new Delete_ProjWorksServiceModel { id = id };
        ...
        /// <summary>
        /// Tìm dữ liệu đầu tiên phù hợp model của Bảng ProjWorks - Công việc dự án
        /// </summary>
        ...
        /// </returns>
        [HttpGet("FindOne")]
        public async Task<object> FindOne([FromQuery] FindOne_ProjWorksModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<object> FindOneByID([FromRoute] int id)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = await _sv.FindOne(new FindOne_ProjWorksServiceModel { where = where });
                return await BindData(result.data, result.errors);
            }
            return await BindData();
        }
        ...
        /// <summary>
        /// Đếm số row Bảng ProjWorks theo điều kiện model - Công việc dự án
        /// </summary>
        /// <param name="model"> là biểu thức điều kiện Where truyền lên</param>
        /// <param>
        ///     Kiểm tra ModelState xem có hợp lệ không
        ...
        /// </returns>
        [HttpGet("Count")]
        public async Task<object> Count([FromQuery] Count_ProjWorksModel model)
        {
            if (ModelState.IsValid)
            {
