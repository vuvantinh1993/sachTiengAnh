...
{
    public class ExpectedCostsController : ApiController
    {
        private readonly IExpectedCostsService _sv;
        public readonly ICurrentUserService _currentUserService;

        public ExpectedCostsController(IExpectedCostsService sv, ICurrentUserService currentUserService)
        {
            _sv = sv;
        ...
        /// <summary>
        /// lấy dữ liệu Bảng ExpectedCosts - Chi phí kế hoạch
        /// </summary>
        /// <param name="model">
        ...
        /// </returns>
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] Search_ExpectedCostsModel model)
        {
        ...
        /// <summary>
        /// thêm dữ liệu Bảng ExpectedCosts - Chi phí kế hoạch
        /// </summary>
        /// <param name="model">
        ...
        /// </returns>
        [HttpPost]
        public async Task<object> Add([FromBody] Add_ExpectedCostsModel model)
        {
            var modelService = model.MapToObject<Add_ExpectedCostsServiceModel>();
        ...
        /// <summary>
        /// sửa dữ liệu Bảng ExpectedCosts - Chi phí kế hoạch
        /// </summary>
        ...
        /// </returns>
        [HttpPut("{id}")]
        public async Task<object> Edit(int id, [FromBody] Edit_ExpectedCostsModel model)
        {

            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Edit_ExpectedCostsServiceModel>();
                //set value default
                modelService.id = id;
        ...
        /// <summary>
        /// Chỉnh sửa một số dữ liệu Bảng ExpectedCosts - Chi phí kế hoạch
        /// </summary>
        /// <param name="id"> là id của đối tượng cần chỉnh sửa </param>
        ...
        /// <summary>
        /// Xóa dữ liệu Bảng ExpectedCosts theo id - Chi phí kế hoạch
        /// </summary>
        ...
        public async Task<object> Delete(int id)
        {
            ...
            if (ModelState.IsValid)
            {
                var modelService = new Delete_ExpectedCostsServiceModel { id = id };
                //set value default
        ...
        /// <summary>
        /// Tìm dữ liệu đầu tiên phù hợp model của Bảng ExpectedCosts - Chi phí kế hoạch
        /// </summary>
        ...
        /// </returns>
        [HttpGet("FindOne")]
        public async Task<object> FindOne([FromQuery] FindOne_ExpectedCostsModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        /// <summary>
        /// Tìm dữ liệu đầu tiên phù hợp id của Bảng ExpectedCosts - Chi phí kế hoạch
        /// </summary>
        ...
        public async Task<object> FindOneById([FromRoute] int id)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = await _sv.FindOne(new FindOne_ExpectedCostsServiceModel { where = where });
                return await BindData(result.data, result.errors);
            }
            return await BindData();
        }
        ...
        /// <summary>
        /// Đếm số row Bảng ExpectedCosts theo điều kiện model - Chi phí kế hoạch
        /// </summary>
        /// <param name="model"> là biểu thức điều kiện Where truyền lên</param>
        /// <param>
        ///     Kiểm tra ModelState xem có hợp lệ không
        ...
        /// </returns>
        [HttpGet("Count")]
        public async Task<object> Count([FromQuery] Count_ExpectedCostsModel model)
        {
            if (ModelState.IsValid)
            {
