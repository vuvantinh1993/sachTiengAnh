...
namespace CTIN.WebApi.Modules.General.Controllers
{
    ...
    {
        private readonly IIssueService _sv;
        public readonly ICurrentUserService _currentUserService;

        public IssueController(IIssueService sv, ICurrentUserService currentUserService)
        {
            _sv = sv;
        ...
        /// <summary>
        /// lấy dữ liệu Bảng Issue - Thông tin vấn đề
        /// </summary>
        /// <param name="model">
        ...
        /// </returns>
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] Search_IssueModel model)
        {
        ...
        /// <summary>
        /// thêm dữ liệu Bảng Issue - Thông tin vấn đề
        /// </summary>
        /// <param name="model">
        ...
        /// </returns>
        [HttpPost]
        public async Task<object> Add([FromBody] Add_IssueModel model)
        {
            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Add_IssueServiceModel>();
                //set value default
                modelService.createdDate = DateTime.Now;
                modelService.createdBy = _currentUserService.userId;
                modelService.modifiedBy = _currentUserService.userId;
                modelService.modifiedDate = DateTime.Now;
        ...
        private void checkErrors(Add_IssueServiceModel modelService)
        {
            if (modelService.endDate != null && (modelService.endDate < modelService.beginDate))
            {
                ModelState.AddModelError("endDate", "Ngày kết thúc phải lớn hơn ngày bắt đầu");
            }
        }

        /// <summary>
        /// sửa dữ liệu Bảng Issue - Thông tin vấn đề
        /// </summary>
        ...
        /// </returns>
        [HttpPut("{id}")]
        public async Task<object> Edit(int id, [FromBody] Edit_IssueModel model)
        {
            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Edit_IssueServiceModel>();
                //set value default
                modelService.id = id;
                modelService.modifiedBy = _currentUserService.userId;
                modelService.modifiedDate = DateTime.Now;
        ...
        /// <summary>
        /// Chỉnh sửa một số dữ liệu Bảng Issue - Thông tin vấn đề
        /// </summary>
        /// <param name="id"> là id của đối tượng cần chỉnh sửa </param>
        ...
        /// <summary>
        /// Xóa dữ liệu Bảng Issue theo id - Thông tin vấn đề
        /// </summary>
        ...
        public async Task<object> Delete(int id)
        {
            if (ModelState.IsValid)
            {
                var modelService = new Delete_IssueServiceModel { id = id };
        ...
        /// <summary>
        /// Tìm dữ liệu đầu tiên phù hợp model của Bảng Issue - Thông tin vấn đề
        /// </summary>
        ...
        /// </returns>
        [HttpGet("FindOne")]
        public async Task<object> FindOne([FromQuery] FindOne_IssueModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<object> FindOneById([FromRoute] int id)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = await _sv.FindOne(new FindOne_IssueServiceModel { where = where });
                return await BindData(result.data, result.errors);
            }
            return await BindData();
        }
        ...
        /// <summary>
        /// Đếm số row Bảng Issue theo điều kiện model - Thông tin vấn đề
        /// </summary>
        /// <param name="model"> là biểu thức điều kiện Where truyền lên</param>
        /// <param>
        ///     Kiểm tra ModelState xem có hợp lệ không
        ...
        /// </returns>
        [HttpGet("Count")]
        public async Task<object> Count([FromQuery] Count_IssueModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpGet("ListPriority")]
        public async Task<object> ListPriority()
        {
            var listData = Enum.GetValues(typeof(Common.Enums.Priority))
                               .Cast<Common.Enums.Priority>()
                               .Select(x => new { id = (int)x, name = EnumExtension.ToName(x) });

            return await BindData(listData);
        }

        [HttpGet("ListLevelIssue")]
        public async Task<object> ListLevelIssue()
        {
            var listData = Enum.GetValues(typeof(Common.Enums.LevelIssue))
                               .Cast<Common.Enums.LevelIssue>()
                               .Select(x => new { id = (int)x, name = EnumExtension.ToName(x) });
