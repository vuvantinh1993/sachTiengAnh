...
namespace CTIN.WebApi.Modules.General.Controllers
{
    ...
    {
        private readonly IPaymentTypeService _sv;
        public readonly ICurrentUserService _currentUserService;

        public PaymentTypeController(IPaymentTypeService sv, ICurrentUserService currentUserService)
        {
            _sv = sv;
        ...
        /// <summary>
        /// lấy dữ liệu Bảng PaymentType - Kiểu thanh toán
        /// </summary>
        /// <param name="model">
        ...
        /// </returns>
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] Search_PaymentTypeModel model)
        {
        ...
        /// <summary>
        /// thêm dữ liệu Bảng PaymentType - Kiểu thanh toán
        /// </summary>
        /// <param name="model">
        ...
        /// </returns>
        [HttpPost]
        public async Task<object> Add([FromBody] Add_PaymentTypeModel model)
        {
            var modelService = model.MapToObject<Add_PaymentTypeServiceModel>();
            //set value default
        ...
        /// <summary>
        /// sửa dữ liệu Bảng PaymentType - Kiểu thanh toán
        /// </summary>
        ...
        /// </returns>
        [HttpPut("{id}")]
        public async Task<object> Edit(int id, [FromBody] Edit_PaymentTypeModel model)
        {

            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Edit_PaymentTypeServiceModel>();
                //set value default
                modelService.id = id;
        ...
        /// <summary>
        /// Chỉnh sửa một số dữ liệu Bảng PaymentType - Kiểu thanh toán
        /// </summary>
        /// <param name="id"> là id của đối tượng cần chỉnh sửa </param>
        ...
        /// <summary>
        /// Xóa dữ liệu Bảng PaymentType theo id - Kiểu thanh toán
        /// </summary>
        ...
        public async Task<object> Delete(int id)
        {
            ...
            if (ModelState.IsValid)
            {
                var modelService = new Delete_PaymentTypeServiceModel { id = id };
                //set value default
        ...
        /// <summary>
        /// Tìm dữ liệu đầu tiên phù hợp model của Bảng PaymentType - Kiểu thanh toán
        /// </summary>
        ...
        /// </returns>
        [HttpGet("FindOne")]
        public async Task<object> FindOne([FromQuery] FindOne_PaymentTypeModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        /// <summary>
        /// Tìm dữ liệu đầu tiên phù hợp id của Bảng PaymentType - Kiểu thanh toán
        /// </summary>
        ...
        public async Task<object> FindOneById([FromRoute] int id)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = await _sv.FindOne(new FindOne_PaymentTypeServiceModel { where = where });
                return await BindData(result.data, result.errors);
            }
            return await BindData();
        }
        ...
        /// <summary>
        /// Đếm số row Bảng PaymentType theo điều kiện model - Kiểu thanh toán
        /// </summary>
        /// <param name="model"> là biểu thức điều kiện Where truyền lên</param>
        /// <param>
        ///     Kiểm tra ModelState xem có hợp lệ không
        ...
        /// </returns>
        [HttpGet("Count")]
        public async Task<object> Count([FromQuery] Count_PaymentTypeModel model)
        {
            if (ModelState.IsValid)
            {
