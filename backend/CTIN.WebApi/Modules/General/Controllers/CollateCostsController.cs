...
{
    public class CollateCostsController : ApiController
    {
        private readonly ICollateCostsService _sv;
        public readonly ICurrentUserService _currentUserService;

        public CollateCostsController(ICollateCostsService sv, ICurrentUserService currentUserService)
        {
            _sv = sv;
        ...
        /// <summary>
        /// lấy dữ liệu Bảng CollateCosts - Chi phí đối chiếu
        /// </summary>
        /// <param name="model">
        ...
        /// </returns>
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] Search_CollateCostsModel model)
        {
        ...
        /// <summary>
        /// thêm dữ liệu Bảng CollateCosts - Chi phí đối chiếu
        /// </summary>
        /// <param name="model">
        ...
        /// </returns>
        [HttpPost]
        public async Task<object> Add([FromBody] Add_CollateCostsModel model)
        {
            var modelService = model.MapToObject<Add_CollateCostsServiceModel>();
        ...
        /// <summary>
        /// sửa dữ liệu Bảng CollateCosts - Chi phí đối chiếu
        /// </summary>
        /// <param name="vouchersNumber"> là id của đối tượng cần chỉnh sửa </param>
        ...
        /// </returns>
        [HttpPut("{id}")]
        public async Task<object> Edit(int id, [FromBody] Edit_CollateCostsModel model)
        {

            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Edit_CollateCostsServiceModel>();
                //set value default
                modelService.id = id;
        ...
        /// <summary>
        /// Chỉnh sửa một số dữ liệu Bảng CollateCosts - Chi phí đối chiếu
        /// </summary>
        /// <param name="vouchersNumber"> là id của đối tượng cần chỉnh sửa </param>
        ...
        /// <summary>
        /// Xóa dữ liệu Bảng CollateCosts theo id - Chi phí kế hoạch
        /// </summary>
        /// <param name="vouchersNumber"> là id của đối tượng cần xóa </param>
        /// <param>
        ///     Kiểm tra ModelState xem có hợp lệ không
        ...
        public async Task<object> Delete(int id)
        {
            ...
            if (ModelState.IsValid)
            {
                var modelService = new Delete_CollateCostsServiceModel { id = id };
                //set value default
        ...
        /// <summary>
        /// Tìm dữ liệu đầu tiên phù hợp model của Bảng CollateCosts - Chi phí đối chiếu
        /// </summary>
        ...
        /// </returns>
        [HttpGet("FindOne")]
        public async Task<object> FindOne([FromQuery] FindOne_CollateCostsModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        /// <summary>
        /// Tìm dữ liệu đầu tiên phù hợp id của Bảng CollateCosts - Chi phí đối chiếu
        /// </summary>
        ...
        public async Task<object> FindOneById([FromRoute] int id)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = await _sv.FindOne(new FindOne_CollateCostsServiceModel { where = where });
                return await BindData(result.data, result.errors);
            }
            return await BindData();
        }
        ...
        /// <summary>
        /// Đếm số row Bảng CollateCosts theo điều kiện model - Chi phí kế hoạch
        /// </summary>
        /// <param name="model"> là biểu thức điều kiện Where truyền lên</param>
        /// <param>
        ///     Kiểm tra ModelState xem có hợp lệ không
        ...
        /// </returns>
        [HttpGet("Count")]
        public async Task<object> Count([FromQuery] Count_CollateCostsModel model)
        {
            if (ModelState.IsValid)
            {
