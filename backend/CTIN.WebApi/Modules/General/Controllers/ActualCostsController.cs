...
{
    public class ActualCostsController : ApiController
    {
        private readonly IActualCostsService _sv;
        public readonly ICurrentUserService _currentUserService;

        public ActualCostsController(IActualCostsService sv, ICurrentUserService currentUserService)
        {
            _sv = sv;
        ...
        /// <summary>
        /// lấy dữ liệu Bảng ActualCosts - Chi phí thực tế
        /// </summary>
        /// <param name="model">
        ...
        /// </returns>
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] Search_ActualCostsModel model)
        {
        ...
        /// <summary>
        /// thêm dữ liệu Bảng ActualCosts - Chi phí thực tế
        /// </summary>
        /// <param name="model">
        ...
        /// </returns>
        [HttpPost]
        public async Task<object> Add([FromBody] Add_ActualCostsModel model)
        {
            var modelService = model.MapToObject<Add_ActualCostsServiceModel>();
        ...
        /// <summary>
        /// sửa dữ liệu Bảng ActualCosts - Chi phí thực tế
        /// </summary>
        ...
        /// </returns>
        [HttpPut("{id}")]
        public async Task<object> Edit(int id, [FromBody] Edit_ActualCostsModel model)
        {

            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Edit_ActualCostsServiceModel>();
                //set value default
                modelService.id = id;
        ...
        /// <summary>
        /// Chỉnh sửa một số dữ liệu Bảng ActualCosts - Chi phí thực tế
        /// </summary>
        /// <param name="id"> là id của đối tượng cần chỉnh sửa </param>
        ...
        /// <summary>
        /// Xóa dữ liệu Bảng ActualCosts theo id - Chi phí kế hoạch
        /// </summary>
        ...
        public async Task<object> Delete(int id)
        {
            ...
            if (ModelState.IsValid)
            {
                var modelService = new Delete_ActualCostsServiceModel { id = id };
                //set value default
        ...
        /// <summary>
        /// Tìm dữ liệu đầu tiên phù hợp model của Bảng ActualCosts - Chi phí thực tế
        /// </summary>
        ...
        /// </returns>
        [HttpGet("FindOne")]
        public async Task<object> FindOne([FromQuery] FindOne_ActualCostsModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        /// <summary>
        /// Tìm dữ liệu đầu tiên phù hợp id của Bảng ActualCosts - Chi phí thực tế
        /// </summary>
        ...
        public async Task<object> FindOneById([FromRoute] int id)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = await _sv.FindOne(new FindOne_ActualCostsServiceModel { where = where });
                return await BindData(result.data, result.errors);
            }
            return await BindData();
        }
        ...
        /// <summary>
        /// Đếm số row Bảng ActualCosts theo điều kiện model - Chi phí kế hoạch
        /// </summary>
        /// <param name="model"> là biểu thức điều kiện Where truyền lên</param>
        /// <param>
        ///     Kiểm tra ModelState xem có hợp lệ không
        ...
        /// </returns>
        [HttpGet("Count")]
        public async Task<object> Count([FromQuery] Count_ActualCostsModel model)
        {
            if (ModelState.IsValid)
            {
