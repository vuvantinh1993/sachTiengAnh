...
namespace CTIN.WebApi.Modules.General.Controllers
{
    ...
    {
        private readonly IPaymentScheduleService _sv;
        public readonly ICurrentUserService _currentUserService;

        public PaymentScheduleController(IPaymentScheduleService sv, ICurrentUserService currentUserService)
        {
            _sv = sv;
        ...
        /// <summary>
        /// lấy dữ liệu Bảng PaymentSchedule - Lịch thanh toán
        /// </summary>
        /// <param name="model">
        ...
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] Search_PaymentScheduleModel model)
        {
        ...
        /// <summary>
        /// thêm dữ liệu Bảng PaymentSchedule - Lịch thanh toán
        /// </summary>
        /// <param name="model">
        ...
        /// </returns>
        [HttpPost]
        public async Task<object> Add([FromBody] Add_PaymentScheduleModel model)
        {

            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Add_PaymentScheduleServiceModel>();
                //set value default
        ...
        /// <summary>
        /// sửa dữ liệu Bảng PaymentSchedule - Lịch thanh toán
        /// </summary>
        ...
        /// </returns>
        [HttpPut("{id}")]
        public async Task<object> Edit(int id, [FromBody] Edit_PaymentScheduleModel model)
        {
            if (ModelState.IsValid)
            {
                var modelService = model.MapToObject<Edit_PaymentScheduleServiceModel>();
                //set value default
                modelService.id = id;
                modelService.modifiedBy = _currentUserService.userId;
                modelService.modifiedDate = DateTime.Now;
        ...
        /// <summary>
        /// Chỉnh sửa một số dữ liệu Bảng PaymentSchedule - Lịch thanh toán
        /// </summary>
        /// <param name="id"> là id của đối tượng cần chỉnh sửa </param>
        ...
        /// <summary>
        /// Xóa dữ liệu Bảng PaymentSchedule theo id - Lịch thanh toán
        /// </summary>
        ...
        public async Task<object> Delete(int id)
        {
            if (ModelState.IsValid)
            {
                var modelService = new Delete_PaymentScheduleServiceModel { id = id, userId = GetUserId() };
        ...
        /// <summary>
        /// Tìm dữ liệu đầu tiên phù hợp model của Bảng PaymentSchedule - Lịch thanh toán
        /// </summary>
        ...
        /// </returns>
        [HttpGet("FindOne")]
        public async Task<object> FindOne([FromQuery] FindOne_PaymentScheduleModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<object> FindOneByID([FromRoute] long id)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = await _sv.FindOne(new FindOne_PaymentScheduleServiceModel { where = where });
                return await BindData(result.data, result.errors);
            }
            return await BindData();
        }
        ...
        /// <summary>
        /// Đếm số row Bảng PaymentSchedule theo điều kiện model - Lịch thanh toán
        /// </summary>
        /// <param name="model"> là biểu thức điều kiện Where truyền lên</param>
        /// <param>
        ///     Kiểm tra ModelState xem có hợp lệ không
        ...
        /// </returns>
        [HttpGet("Count")]
        public async Task<object> Count([FromQuery] Count_PaymentScheduleModel model)
        {
            if (ModelState.IsValid)
            {
